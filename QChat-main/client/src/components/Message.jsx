    ...
    return (
        <div className='flex flex-col w-2/3 h-screen my-1 justify-center'>
            <div className='items-center flex flex-col bg-gray-50 h-5/6 rounded-lg pb-2'>
                <h3 className='text-2xl font-bold bg-blue-500 px-2 py-1 rounded rounded-b-none w-full text-center'>Messages</h3>
                <div className='flex-grow p-4 overflow-y-auto w-full'>
                    {
                        ...
                        messages.map((message, index) => {
                            return (
                                ...
                                <div key={index} className={` text-justify px-4 p-2 bg-white my-4 w-1/4 rounded-2xl text-lg ${message.isMine ? 'ml-auto rounded-br-none bg-blue-200 bg-opacity-50' : 'rounded-bl-none'
                                    }`}>
                                    {message.msg}
                                </div>
                                </Typography>
